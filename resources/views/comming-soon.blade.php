...
<head>
    ...
    @endif
    <meta charset="UTF-8">
    <title>Babvip Contact us under maintenance</title>
...
<body style="background: #1663c561;">
    <a href="{{ url('/') }}" class="navbar-brand d-flex align-items-center mb-md-0 text-decoration-none pt-5" style="justify-content: center">
        @if(!empty($decodeData) )
        <img src="{{ asset("storage/uploads/".$decodeData["site_logo"]) }}" alt="{{ $decodeData["site_logo_alt"] }}" class="img-fluid">
        @endif
    </a>
    <hr>

    <!-- <h1 style="text-align:center;margin-top:10px;margin-bottom:10px;color:#9c2056a6">Coming Soon</h1> -->
    <marquee style="height:40px;background-color:000;font:20px;padding-top:5px;color:#fff;font-weight:bold;">We Are Coming Soon.</marquee>
  ...
  ------------------------------------------------------------>
        <div>
            <h1 class="title text-center mb-4" style="color: #a05989;">Contact us for Enquiry</h1>
    ...
    <div>
        <div style='text-align:center; margin-top:50px;'>
            ...
            <a href="{{ $decodeData['facebook_page_url'] }}" class="sc_facebook" target="_blank"><img src="https://graphicollections.com/front/socialmediaicons50X50/fb.png" alt="fb" /></a>
            @endif
            @if(!empty($siteSetting) && $decodeData['instagram_page_url'] !== null)
            <a href="{{ $decodeData['instagram_page_url'] }}" class="sc_instagram" target="_blank"><img src="https://graphicollections.com/front/socialmediaicons50X50/insta.png" alt="insta" /></a>
            @endif
            @if(!empty($siteSetting) && $decodeData['linkdin_page_url'] !== null)
            <a href="{{ $decodeData['linkdin_page_url'] }}" class="sc_google" target="_blank"><img src="https://graphicollections.com/front/socialmediaicons50X50/linkedin.png" alt="linkedin" /></a>
            @endif
            <p class="copy-line">{{ !empty($footerSetting) && ($decodeDataFooter['footer_tag_line'] !== null) ? $decodeDataFooter['footer_tag_line'] : ''}} </p>
        </div>
        <!-- partial -->
        ...
        <script>
            $(document).ready(function() {
                $('.contactForm').on('submit', function(e) {
                    ...
                    $.ajax({
                        url: '{{ route("saveMaintinanceEnquery") }}',
                        type: 'POST',
                        data: $(this).serialize(),
