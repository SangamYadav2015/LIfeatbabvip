                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" action="{{ route('admin.updateUser', ['num' => $userData->id ])}}" method="post" novalidate autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <select class="form-control" required name="department_id" id="department_id">
                                                    ...
                                                    <option value="{{ $department->id }}" {{ $department->id === $userData->department_id ? 'selected' : ''}}>{{ $department->Department_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control" name="email" id="email" required placeholder="Enter Email ID" value="{{ $userData->email }}">
