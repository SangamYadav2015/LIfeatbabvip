                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" action="{{ route('admin.updateProfile', ['num' => $userData->id ])}}" method="post" novalidate autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" class="form-control" name="old_profile" id="old_profile" value="{{ $userData->profile_image }}">
                                        <div class="row">
                                        <div class="col-md-6">
                                                <label class="form-label" for="department_id">Select Department</label>
                                                <input type="text" value="{{ $userData->department->Department_name}}" class="form-control" readonly>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="designation">Select Role</label>
                                                <input type="text" value="{{ $userData->userRole->role_title}}" class="form-control" readonly>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="name" id="name" required placeholder="Enter Full Name" value="{{ $userData->name }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control"  id="email" required placeholder="Enter Email ID" value="{{ $userData->email }}" readonly>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="phone_number" id="phone_number" required placeholder="Enter Phone number"  value="{{ $userData->phone_number }}">
                                                    <div class="invalid-feedback">
                                        ...
                                        <!-- <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="password" class="form-control" name="password" id="password" placeholder="Enter Password" value="{{ $userData->password }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="password" class="form-control" name="cpassword" id="cpassword" placeholder="Enter Password" value="{{ $userData->password }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <a href="{{ asset('storage/uploads/'.$userData->profile_image) }}" target="_blank">view Image</a>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="address" id="address" placeholder="Enter Address" value="{{ $userData->address }}">
                                                    <div class="invalid-feedback">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.message) {
                        ...
                        var SelectedDepartment = "{{ $userData->designation }}"; // Get the section_style_id from Blade

                        var roleHtml = '<option value="">Select Section Style</option>';
                        $.each(response, function(index, role) {
                            var selectedItem = '';
                            if (role.id == SelectedDepartment) {
                                selectedItem = 'selected';
                            }
                            roleHtml += '<option value="' + role.id + '" ' + selectedItem + '>' + role.role_title + '</option>';
                        });
