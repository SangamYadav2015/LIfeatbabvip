            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Maintenance Enquiry List</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <form class="needs-validation" action="{{ route('admin.maintinanceEnqueryList') }}" method="get" novalidate="" autocomplete="off" id="searchForm">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                ...
                <div class="card-header">
                    <h4 class="card-title">Maintenance Enquiry List
                         <a href="{{ route('admin.maintinanceEnqueryExport') }}"><button class="btn btn-primary" type="button" style="float:right">Export Data CSV</button></h4>
