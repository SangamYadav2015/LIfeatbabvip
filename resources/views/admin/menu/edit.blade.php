                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" action="{{ route('admin.updataMenu',['num'=> $menuRecord->id])}}" method="post" novalidate autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" value="{{  $menuRecord->menu_image }}" name="menu_image_old">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control" id="parent_id" name="parent_id">
                                                        ...
                                                        {{ displayMenuOption($menu, '', 0, $menuRecord->parent_id) }}
                                                        @endif
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="title" id="title" required value="{{ $menuRecord->title }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="menu_slug" id="menu_slug" value="{{ $menuRecord->menu_slug }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="mb-3 col-md-4" id="menu_parent" {{ $menuRecord->parent_id !== null ? ' style=display:none;':'' }}>
                                                <label class="form-label col-md-12" for="is_horizontal">Is Horizontal</label>
                                                <input type="checkbox" class="" id="is_horizontal" switch="success" name="is_horizontal" value="1" {{ $menuRecord->is_horizontal === 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input type="checkbox" class="" id="showHeader" switch="success" name="show_header" value="1" {{ $menuRecord->show_header === 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input type="checkbox" class="" id="showfooter" switch="success" name="show_footer" value="1" {{ $menuRecord->show_footer === 1 ? 'checked' : '' }}>
                                                <label for="showfooter" data-on-label="Yes" data-off-label="No"></label>
                                            </div>
                                        </div>
                                        <div class="row" id="menu_child" {{ $menuRecord->parent_id ? '':' style=display:none;' }} >
                                            <div class="mb-3 col-md-6">
                                                ...
                                                @if($menuRecord->menu_image)
                                                <a href="{{ asset('storage/uploads/'.$menuRecord->menu_image) }}" target="_blank">view Image</a>
                                                @endif
                                            </div>

                                            <div class="mb-3 col-md-6">
                                                <label class="form-label col-md-12" for="menu_description">Menu Short Summary</label>
                                                <input type="text" class="form-control" id="menu_description" name="menu_description" placeholder="Enter Menu Short Summary" value="{{ $menuRecord->menu_description }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control" id="statusa" name="status" required>
                                                        <option value="1" {{ $menuRecord->status === 1 ? 'selected' : '' }}>Active</option>
                                                        <option value="0" value="1" {{ $menuRecord->status === 0 ? 'selected' : '' }}>Inactive</option>
                                                    </select>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="sort_id" name="sort_id" required readonly value="{{  $menuRecord->sort_id }}">
