                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="image">Image </label><span class="text-small text-danger">( Image size
                                                        must be 970 x 749 px )</span>
                                                    <input type="file" name="image" class="form-control image-check" id="image" data-width="970" data-height="749">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="image_alt_tag">Image 
                                                        Alt Tag</label>
                                                    <input type="text" name="image_alt_tag" class="form-control" id="image_alt_tag" placeholder="Image Alt Tag" value="">
                                                </div>
                                            </div>
                                         ...
                                         <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="image_title" class="form-control" id="image_title" placeholder="Image Title"  required>
                                                     <div class="invalid-feedback">
                                               ...
                                               <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="image_sub_title">Image Subtitle</label>
                                                    <input type="text" name="image_sub_title" class="form-control" id="image_sub_title" placeholder="Image Subtitle"  required>
                                                     <div class="invalid-feedback">
                                                        Please Enter Image Subtitle!
                                                    </div>   
                                                </div>
                                            </div>
                                        </div>
