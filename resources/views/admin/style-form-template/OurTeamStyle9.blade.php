<div class="row">
                                             ...
                                             <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label class="form-label" for="banner_bg_image">Banner BG 
                                                        Image</label><span class="text-small text-danger">( Image size must be 575 x 990 px )</span>
                                                    <input type="file" name="banner_bg_image" class="form-control image-check" id="banner_bg_image" required data-width="575" data-height="990" >
                                         ...
                                         <div class="row">
                                            <div class="col-md-6">
                                               ...
                                               <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="link_url">Button URL</label>
