                                       ...
                                       <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="image1">Image 1</label><span class="text-small text-danger">( Image size
                                                        must be 194 x 162 px )</span>
                                                    <input type="file" name="image1" class="form-control image-check" id="image1" required="" data-width="194" data-height="162">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="image2">Image 2</label><span class="text-small text-danger">( Image size
                                                        must be 448 x 599 px )</span>
                                                    <input type="file" name="image2" class="form-control image-check" id="image2" required="" data-width="448" data-height="599">
                                                    <div class="img-alert"></div>
                                                    <div class="invalid-feedback">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="image3">Image 3</label><span class="text-small text-danger">( Image size
                                                        must be 197 x 201 px )</span>
                                                    <input type="file" name="image3" class="form-control image-check" id="image3" required="" data-width="197" data-height="201">
                                                    <div class="img-alert"></div>
                                                    <div class="invalid-feedback">
                                         ...
                                         <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="image4">Image 4</label><span class="text-small text-danger">( Image size
                                                        must be 306 x 169 px )</span>
                                                    <input type="file" name="image4" class="form-control image-check" id="image4" required="" data-width="306" data-height="169">
                                                    <div class="img-alert"></div>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="image4_alt_tag">Image 4
                                                        Alt Tag</label>
                                                    <input type="text" name="image4_alt_tag" class="form-control" id="image4_alt_tag" placeholder="Image 4 Alt Tag">
                                                </div>
                                            </div>
                                          ...
                                          <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="link_text[]" class="form-control" id="link_text" required=""  placeholder="Link Text">
                                                    <div class="img-alert"></div>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="link_url">Link URL
                                                      </label>
