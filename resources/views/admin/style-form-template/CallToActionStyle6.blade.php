<div class="row">
    <div class="col-md-6">
        <div class="mb-3">
            <label class="form-label" for="title">Video Url</label>
    ...
    <div class="col-md-6">
         <div class="mb-3">
            <label class="form-label" for="banner_bg_image">Video BG Image
            </label><span class="text-small text-danger">( Image size must be 950 x 633 px )</span>
            <input type="file" name="banner_bg_image" class="form-control image-check" id="banner_bg_image"
                required data-width="950" data-height="633">
            <div class="img-alert"></div>
            <div class="invalid-feedback">
                Please Choose Video BG Image!
            </div>
        </div>
    </div>   
</div>
