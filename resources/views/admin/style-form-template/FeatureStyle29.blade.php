                                            ...
                                            <div class="col-md-4">
                                             ...
                                             <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="video_url" class="form-control" id="video_url" placeholder="Video URL"  required>
                                                     <div class="invalid-feedback">
                                               ...
                                               <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="image"> 
                                                            Image</label><span class="text-small text-danger">( Image size must be 570 x 588 px )</span>
                                                        <input type="file" name="image" class="form-control image-check" id="image" required  data-width="570" data-height="588">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="step_subtitle[]" class="form-control" id="step_subtitle" placeholder="Step Subtitle">
                                                    <div class="invalid-feedback">
