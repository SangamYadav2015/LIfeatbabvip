<div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="image1">Image 1</label><span
                                                        ...
                                                        must be 354 x 374 px )</span>
                                                    <input type="file" name="image1" class="form-control image-check"
                                                        id="image1" required data-width="354" data-height="374">
                                                    <div class="img-alert"></div>
                                                    <div class="invalid-feedback">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="video_button_text">Video Button
                                                        Text</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="video_button_url">Video Button
                                                        URL</label>
                                                    <input type="text" class="form-control" id="video_button_url"
                                                        name="video_button_url" placeholder="Video Button URL">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label class="form-label" for="banner_description">Banner
                                                        Description</label>
                                                    <textarea type="text" class="form-control" id="banner_description" name="banner_description" placeholder="Banner Description" required=""></textarea>
                                                    <div class="invalid-feedback">
