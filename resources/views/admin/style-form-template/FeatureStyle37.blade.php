<div class="row">
          ...
          <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="image1">Image 1</label><span class="text-small text-danger">( Image size
                                                        must be 173 x 183 px )</span>
                                                    <input type="file" name="image1" class="form-control image-check" id="image1" required="" data-width="173" data-height="183">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="image2">Image 2</label><span class="text-small text-danger">( Image size
                                                        must be 662 x 632 px )</span>
                                                    <input type="file" name="image2" class="form-control image-check" id="image2" required="" data-width="662" data-height="632">
                                                    <div class="img-alert"></div>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="image3">Image 3</label><span class="text-small text-danger">( Image size
                                                        must be 260 x 101 px )</span>
                                                    <input type="file" name="image3" class="form-control image-check" id="image3" required="" data-width="260" data-height="101">
                                                    <div class="img-alert"></div>
                                                    <div class="invalid-feedback">
                                       ...
                                       <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label class="form-label" for="description">Description 2</label>
                                                <textarea name="description" class="form-control" id="description" placeholder="Description 2" required=""></textarea>
                                            </div>
                                        </div>
                                    </div>
                                         ...
                                         <div class="row">
                                                <div class="col-md-6">
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="step_sub_title[]" id="step_sub_title" placeholder="Step Subtitle" required="">
                                                        <div class="invalid-feedback">
                                                            Please Enter Step  Title!
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="step_image_icon_alt_tag[]" class="form-control image-check" id="step_image_icon_alt_tag" placeholder="Step Image Icon Alt Tag">
                                                </div>
                                            </div>
                                         </div>
