                                         ...
                                         <div class="row">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label" for="step_image_icon">Step Image Icon 
                                                        </label><span class="text-small text-danger">( Image size must be 189 x 180 px )</span>
                                                    <input type="file" name="step_image_icon[]" class="form-control image-check" id="step_image_icon" required="" data-width="189" data-height="180">
