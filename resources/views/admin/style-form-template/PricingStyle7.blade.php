                                   ...
                                   <div class="card-body">
                                        <div id="review-sections">
                                         ...
                                         <div class="row">
                                                <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="step_image">Plan Image Icon 
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="step_image_alt_tag">Plan Icon Alt Tag </label>
                                                    <input type="text" name="step_image_alt_tag[]" class="form-control image-check" id="step_image_alt_tag" placeholder="Plan Icon Alt Tag">
                                                </div>
                                            </div>
                                         </div>
                                          ...
                                          <div class="row">
                                                <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="step_image_icon">Plan Offer Icon 
                                                        </label><span class="text-small text-danger">( Image size must be 45 x 74 px )</span>
                                                    <input type="file" name="step_image_icon[]" class="form-control image-check" id="step_image_icon" data-width="45" data-height="74">
                                                    <div class="img-alert"></div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="step_image_icon_alt_tag">Plan Offer Icon Alt Tag </label>
