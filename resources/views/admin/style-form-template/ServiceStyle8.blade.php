                                                                ...
                                                                <div id="review-sections">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="mb-3">
                                                                                <label class="form-label"
                                                                                    for="service_image_icon">Service
                                                                                    Image Icon
                                                                                </label><span
                                                                                    class="text-small text-danger">(
                                                                                    Image size must be 40 x 40 px
                                                                                    )</span>
                                                                                <input type="file"
                                                                                    name="service_image_icon[]"
                                                                                    class="form-control image-check"
                                                                                    id="service_image_icon" required
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="mb-3">
                                                                                <label class="form-label"
                                                                                    for="service_image_icon_alt_tag">Service
                                                                                    Image Icon Alt Tag </label>
                                                                                <input type="text"
                                                                                    name="service_image_icon_alt_tag[]"
                                                                                    class="form-control image-check"
                                                                                    id="service_image_icon_alt_tag">
                                                                                <div class="invalid-feedback">
                                                                                    Please Enter Service Image Icon Alt
                                                                                    Tag!
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3">
                                                                                <label class="form-label"
                                                                                    for="step_image_icon">Service Image
                                                                                </label><span
                                                                                    class="text-small text-danger">(
                                                                                    Image size
                                                                                    must be 176 x 29 px )</span>
                                                                                <input type="file"
                                                                                    name="step_image_icon[]"
                                                                                    class="form-control image-check"
                                                                                    id="step_image_icon" required=""
                                                                                    data-width="176" data-height="29">
                                                                                <div class="img-alert"></div>
                                                                                <div class="invalid-feedback">
                                                                                    Please Choose Image!
                                                                                </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3">
                                                                                <label class="form-label"
                                                                                    for="step_image_icon_alt_tag">
                                                                                    Service Image Image Alt
                                                                                    Tag </label>
                                                                                <input type="text"
                                                                                    name="step_image_icon_alt_tag[]"
                                                                                    class="form-control image-check"
                                                                                    id="step_image_icon_alt_tag"
                                                                                    placeholder="Service Image Alt Tag!">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="mb-3">
                                                                                <label class="form-label"
                                                                                    for="service_description">Service
                                                                                    Description</label>
                                                                                <textarea type="text"
