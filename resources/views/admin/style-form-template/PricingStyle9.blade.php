                                        ...
                                        <div class="row">
                                             <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="offer_title[]" class="form-control" id="offer_title" placeholder="Offer Title" required>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="offer_title">Subtitle</label>
