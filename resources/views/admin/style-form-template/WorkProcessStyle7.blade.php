                                ...
                                <div class="card-header">
                                   ...
                                   <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="step_image_alt_tag">Step Image 
                                                        Alt Tag</label>
                                                    <input type="text" name="step_image_alt_tag[]" class="form-control" id="step_image_alt_tag" placeholder="Step Image Alt Tag">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="step_link_text">Step Link Text </label>
                                                    <input type="text" name="step_link_text[]" class="form-control" id="step_link_text" required="" placeholder="Step Link Text">
                                                    <div class="img-alert"></div>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="step_link_url"> Step Link URL 
                                                        Alt Tag</label>
                                                    <input type="text" name="step_link_url[]" class="form-control" id="step_link_url" placeholder="Step Link URL">
                                                </div>
                                            </div>
                                        </div>
