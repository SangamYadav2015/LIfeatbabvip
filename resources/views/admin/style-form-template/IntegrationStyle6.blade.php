<div class="row">
                                         ...
                                         <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label class="form-label" for="title">Bottom Tagline
                                                    </label>
                                                    <input type="text" name="bottom_tagline" class="form-control" id="bottom_tagline"
                                                        placeholder="Bottom Tagline" value="">
                                                </div>
                                            </div>
                                            </div>
