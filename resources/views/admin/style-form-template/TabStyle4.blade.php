                                  ...
                                  <div class="col-md-6">
                                     <div class="mb-3">
                                         <label class="form-label" for="tab_image_${reviewIndex}">Image 
                                            </label><span class="text-small text-danger">( Image size must be 619 x 525 px )</span>
                                             <input type="file" name="tab_image[]" class="form-control image-check" id="tab_image_${reviewIndex}" required  data-width="619" data-height="525">
                                         <div class="img-alert"></div>
                                         <div class="invalid-feedback">
                                             Please Choose  Image!
                                         </div>
                                  ...
                                  <div class="col-md-6">
                                     <div class="mb-3">
                                         <label class="form-label" for="step_image_icon${reviewIndex}">Icon 
                                             ...
                                             <input type="file" name="step_image_icon[]" class="form-control image-check" id="step_image_icon${reviewIndex}" required  data-width="48" data-height="48">
                                         <div class="img-alert"></div>
                                         <div class="invalid-feedback">
                                             Please Choose  Image!
                                         </div>
