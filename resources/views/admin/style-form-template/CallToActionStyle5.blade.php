                                            ...
                                            <div class="col-md-6">
                                               ...
                                               <div class="col-md-6">
                                                 <div class="mb-3">
                                                     ...
                                                     <input type="text" class="form-control" id="button_url" name="button_url" placeholder="Button Url"  required>
                                                     <div class="invalid-feedback">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                 <div class="mb-3">
                                                     ...
                                                     <input type="text" class="form-control" id="video_button_text" name="video_button_text" placeholder="Video Button Text" >
                                                      <div class="invalid-feedback">
                                                         Please Video Button Text!
                                                     </div>
                                               ...
                                               <div class="col-md-6">
                                                 <div class="mb-3">
                                                     ...
                                                     <input type="text" class="form-control" id="video_button_url" name="video_button_url" placeholder="Video Button Url">
                                                     <div class="invalid-feedback">
                                                         Please Enter Video Button Url!
                                                     </div>
                                                 </div>
                                             </div> 
                                        </div>
