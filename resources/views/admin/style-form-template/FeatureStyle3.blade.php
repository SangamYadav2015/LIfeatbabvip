                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label class="form-label" for="banner_bg_image">Banner BG 
                                                        Image</label><span class="text-small text-danger">( Image size must be 1920 x 943 px )</span>
                                                    <input type="file" name="banner_bg_image" class="form-control image-check" id="banner_bg_image" required  data-width="1920" data-height="943">
                                             ...
                                             <div class="col-md-4">    
                                                <div class="mb-3">
                                                        <label class="form-label" for="banner_bg_alt_tag">Banner BG  Alt Tag</label>
                                                        <input type="text" name="banner_bg_alt_tag" class="form-control"  id="banner_bg_alt_tag">
                                                        <div class="invalid-feedback">
