<div class="row">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            <label class="form-label" for="highlited_title">Highlighted Title</label>
            <input type="text" name="highlited_title" class="form-control" id="highlited_title" placeholder="Highlighted Title"  required>
             <div class="invalid-feedback">
...
<div class="row">
    <div class="col-md-6">
         <div class="mb-3">
            ...
            </label><span class="text-small text-danger">( Image size must be 670 x 493 px )</span>
            <input type="file" name="banner_image" class="form-control image-check" id="banner_image"
                required data-width="670" data-height="493">
