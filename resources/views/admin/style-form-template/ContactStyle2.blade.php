                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="step_link_text[]" class="form-control" id="step_link_text"
                                            placeholder="Step Link Text">
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="step_link_url">Step Link Url</label>
                                        <input type="text" name="step_link_url[]" class="form-control" id="step_link_url"
                                            placeholder="Step Link Url">
                                    </div>
                                </div>
                          </div>
                         <div class="row">
