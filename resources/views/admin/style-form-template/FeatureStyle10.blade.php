        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label" for="sub_title">Title 2</label>
                            <input type="text" class="form-control" id="title2" name="title2" placeholder="Sub Title"
                                required>
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-md-6">
                         <div class="mb-3">
                            ...
                            </label><span class="text-small text-danger">( Image size must be 750 x 1624 px )</span>
                            <input type="file" name="banner_image" class="form-control image-check" id="banner_image"
                                required data-width="750" data-height="1624">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label" for="banner_image_alt_tag">Image Alt tag</label>
