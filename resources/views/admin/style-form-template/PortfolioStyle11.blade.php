                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          </label><span class="text-small text-danger">( Image size must be 536 x 366 px )</span>
                          <input type="file" name="step_image_icon[]" class="form-control image-check"
                            id="step_image_icon" required data-width="536" data-height="366">
                ...
                <div class="review-section" style="border-top: 7px solid #fff;">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="mb-3">
                          <label class="form-label" for="step_image_icon">Image Thumbnail
                          </label><span class="text-small text-danger">( Image size must be `+maxWidth+` x `+maxheight+` px )</span>
