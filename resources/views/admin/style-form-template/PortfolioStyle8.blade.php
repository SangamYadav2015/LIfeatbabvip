                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        </label><span class="text-small text-danger">( Image size must be 312 x 384 px )</span>
                        <input type="file" name="step_image_icon[]" class="form-control image-check"
                          id="step_image_icon" required data-width="312" data-height="384">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input type="file" name="step_image_icon[]" class="form-control image-check" id="step_image_icon" required
                            data-width="312" data-height="384">
                          <div class="img-alert"></div>
                          <div class="invalid-feedback">
                            Please Choose  Image Thumbnail!
                          </div>
