  ...
  <div class="col-md-6">
                                              <div class="mb-3">
                                                  ...
                                                  <input type="text" name="sub_title" class="form-control"
                                                      id="sub_title" placeholder="Sub  Title" value="" required>
                                                  <div class="invalid-feedback">
                                                 ...
                                                 <div class="card-body">
                                                      <div id="review-sections">
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                  <div class="mb-3">
                                                                      <label class="form-label" for="client_image">Client Image 
                                                                          </label><span class="text-small text-danger">( Image size must be 200 x 200 px )</span>
                                                                      <input type="file" name="client_image[]" class="form-control image-check" id="client_image" required  data-width="200" data-height="200">
                                                              ...
                                                              <div class="col-md-6">
                                                                  <div class="mb-3">
                                                                      <label class="form-label" for="client_image_alt_tag">Client Image Alt Tag </label>
                                                                      <input type="text" name="client_image_alt_tag[]" class="form-control image-check" id="client_image_alt_tag" >
                                                                      <div class="invalid-feedback">
                                                        ...
                                                        <div class="col-md-12">
                                                           <div class="mb-3">
                                                               ...
                                                               <input type="text" class="form-control" name="review_title[]" id="review_title" placeholder="Review Title"  required>
                                                               <div class="invalid-feedback">
                                                           ...
                                                           <div class="row">
                                                              <div class="col-md-12">
                                                                  <div class="mb-3">
                                                                     <div class="form-group">
                                                                          <label class="form-label" for="review_description">Review Description</label>
                                                                          <textarea class="form-control" id="review_description" name="review_description[]" placeholder="Review Description" required></textarea> 
                                                                          <div class="invalid-feedback">
...
<script>
     ...
     function updateIndexes() {
         $('.review-section').each(function(index) {
             ...
             $(this).find('.video-link').attr('id', 'video_link_' + idx);
             $(this).find('.video-link').attr('name', 'video_link[]');
             $(this).find('.designation').attr('id', 'designation_' + idx);
             $(this).find('.designation').attr('name', 'designation[]');
                           ...
                           <div class="row">
                                   ...
                                   <div class="col-md-6">
                                     <div class="mb-3">
                                         ...
                                         <input type="file" name="client_image[]" class="form-control image-check" id="client_image_${reviewIndex}" required  data-width="200" data-height="200">
                                         <div class="img-alert"></div>
                                         <div class="invalid-feedback">
                                             Please Choose Client Image!
                                         </div>
                              ...
                              <div class="row">
                                ...
                                <div class="mb-3">
                                    <div class="form-group">
                                        <label class="form-label"
                                            for="client_rating_${reviewIndex}">Rating</label>
                                        <select name="client_rating[]" class="form-control"
                                            id="client_rating_${reviewIndex}" required>
                                            <option value="1">1</option>
                                            <option value="2">3</option>
                                            <option value="3">3</option>
                                            <option value="4">4</option>
                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                     <div class="mb-3">
                                        <div class="form-group">
                                             <label class="form-label" for="video_link_${reviewIndex}">Video Link</label>
                                             <input type="text" name="video_link[]" class="form-control" id="video_link_${reviewIndex}" placeholder="Video Link"  required>
                                             <div class="invalid-feedback">
                                                 Please provide a Video Link!
                                             </div>
                                         </div>
