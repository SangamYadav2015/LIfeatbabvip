                                       ...
                                       <div class="row">
                                             ...
                                             <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label class="form-label" for="banner_bg_image">BG 
                                                        Image</label><span class="text-small text-danger">( Image size must be 1917 x 560 px )</span>
                                                    <input type="file" name="banner_bg_image" class="form-control image-check" id="banner_bg_image" required="" data-width="1917"  data-height="560">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="button_text" class="form-control" id="button_text" placeholder="Button Text" value="" required>
                                                    <div class="invalid-feedback">
