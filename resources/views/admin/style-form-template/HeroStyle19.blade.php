<div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="button_text_1">Button 1 Text</label>
                                                    <input type="text" name="button_text_1" class="form-control"
                                                        id="button_text_1" placeholder="Button 1 Text" value="">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="button_url_1">Button 1 URL</label>
                                                    <input type="text" class="form-control" id="button_url_1" name="button_url_1"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="button_text_2">Button 2 Text</label>
                                                    <input type="text" name="button_text_2" class="form-control"
                                                        id="button_text_2" placeholder="Button 2 Text" value="">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="button_url_2">Button 2 URL</label>
