<div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label" for="highlighted_title">Button URL</label>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label" for="video_text">Video Text</label>
                  <input type="text" class="form-control" id="video_text" name="video_text" placeholder="Video Text">
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <textarea class="form-control" name="main_description" id="description" name="main_description"
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        </label><span class="text-small text-danger">( Image size must be 1305 x  674px )</span>
                        <input type="file" name="step_image_icon[]" class="form-control image-check"
                          id="step_image_icon" required data-width="1305" data-height="674">
                ...
                <div class="review-section" style="border-top: 7px solid #fff;">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="mb-3">
                          <label class="form-label" for="step_image_icon">Image Thumbnail
                          </label><span class="text-small text-danger">( Image size must be 1305  x 674 px )</span>
                          <input type="file" name="step_image_icon[]" class="form-control image-check" id="step_image_icon" required
                            data-width="1305" data-height="674">
                          <div class="img-alert"></div>
                          <div class="invalid-feedback">
                            Please Choose  Image Thumbnail!
                          </div>
