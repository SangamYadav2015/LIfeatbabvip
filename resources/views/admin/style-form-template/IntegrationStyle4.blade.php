                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            </label><span class="text-small text-danger">( Image size must be 650 x 399 px )</span>
                            <input type="file" name="banner_image" class="form-control image-check" id="banner_image"
                                required data-width="650" data-height="399">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            </label><span class="text-small text-danger">( Image size must be 220 x 279 px )</span>
                            <input type="file" name="banner_image1" class="form-control image-check" id="banner_image1"
                                required data-width="220" data-height="279">
                            <div class="img-alert"></div>
                            <div class="invalid-feedback">
