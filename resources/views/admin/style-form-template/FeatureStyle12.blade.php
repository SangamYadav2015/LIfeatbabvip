<div class="row">
    ...
    <div class="col-md-6">
         <div class="mb-3">
            ...
            </label><span class="text-small text-danger">( Image size must be 523 x 626 px )</span>
            <input type="file" name="banner_image" class="form-control image-check" id="banner_image"
                required data-width="523" data-height="626">
...
<div class="row">
    <div class="col-md-6">
        <div class="mb-3">
            <label class="form-label" for="title">Image 1 Title</label>
            <input type="text" name="image_1_title" class="form-control" id="image_1_title" placeholder="Image 1 Title"  required>
             <div class="invalid-feedback">
                Please Enter Image 1 Title!
            </div>   
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            <label class="form-label" for="sub_title">Image 2 Title</label>
            <input type="text" name="image_2_title" class="form-control" id="image_2_title" placeholder="Image 2 Title"  required>
             <div class="invalid-feedback">
                Please Enter Image 2 Title!
            </div>   
        </div>
    </div>
  </div>
