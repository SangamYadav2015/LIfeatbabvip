<div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" name="image1" class="form-control image-check"
                                                        id="image1" required="" data-width="514" data-height="503">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" name="image2" class="form-control image-check"
                                                        id="image2" required="" data-width="240" data-height="248">
                                                    <div class="img-alert"></div>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="image2_alt_tag"> Image 2 Alt
                                                        Tag</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="bottom_title" class="form-control"
                                                        id="bottom_title" placeholder="Bottom Title" required>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label class="form-label" for="bottom_sub_title">Bottom
                                                        Subtitle</label>
                                                    <input type="text" name="bottom_sub_title" class="form-control"
                                                        id="bottom_sub_title" placeholder="Bottom Subtitle" required>
                                                    <div class="invalid-feedback">
                                                        Please Enter Bottom Subtitle!
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label class="form-label" for="bottom_description">Bottom
                                                        Description</label>
                                                    <input type="text" name="bottom_description" class="form-control"
                                                        id="bottom_description" placeholder="Bottom Description"
                                                        required>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="card-body">
                                                <div id="review-sections">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="step_button_text">Step
                                                                    Button Text</label>
                                                                <input type="text" name="step_button_text[]"
                                                                    class="form-control" id="step_button_text"
                                                                    placeholder="Step Button Text">

                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="step_button_url">Step
                                                                    Button URL</label>
                                                                <input type="text" name="step_button_url[]"
                                                                    class="form-control" id="step_button_url"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="step_button_text">Step Button Text</label>
                                                                <input type="text" name="step_button_text[]"
                                                                    class="form-control" id="step_button_text"
                                                                     placeholder="Step Button Text">
