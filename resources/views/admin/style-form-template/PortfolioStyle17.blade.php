            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <textarea class="form-control" id="main_description" name="main_description" placeholder="Description" required=""></textarea>
                  <div class="invalid-feedback">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        </label><span class="text-small text-danger">( Image size must be 856 x 600 px )</span>
                        <input type="file" name="step_image_icon[]" class="form-control image-check"
                          id="step_image_icon" required data-width="856" data-height="600">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input type="file" name="step_image_icon[]" class="form-control image-check" id="step_image_icon" required
                            data-width="856" data-height="600">
                          <div class="img-alert"></div>
                          <div class="invalid-feedback">
                            Please Choose  Image Thumbnail!
                          </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <div class="img-alert"></div>
                          <div class="invalid-feedback">
                            Please Choose Detail Thumbnail!
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
