                                        ...
                                        <div id="review-sections">
                                          ...
                                          <div class="row">
                                                <div class="col-md-6">
                                                  ...
                                                  <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="step_sub_title">Step Subitle</label>
                                                        <input type="text" class="form-control" name="step_sub_title[]" id="step_sub_title" placeholder="Step Subitle"  required>
                                                        <div class="invalid-feedback">
                                                            Please Enter Step Subitle!
                                                        </div>
                                                    </div>
                                                </div>
                                             </div> 
