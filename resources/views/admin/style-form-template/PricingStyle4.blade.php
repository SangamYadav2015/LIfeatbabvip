                                   ...
                                   <div class="card-body">
                                        <div id="review-sections">
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="plan_sub_title">Plan Subtitle</label>
                                                    <input type="text" name="plan_sub_title[]" class="form-control" id="plan_sub_title" placeholder="Plan Subtitle" required>
                                                    <div class="invalid-feedback">
                                                        Please Enter Plan Subtitle!
                                                    </div>
                                                 </div>
                                            </div>
                                         </div>
