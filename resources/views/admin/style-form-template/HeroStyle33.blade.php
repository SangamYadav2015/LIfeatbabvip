                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label class="form-label" for="banner_bg_image">Banner
                                                      BG  Image</label><span class="text-small text-danger">( Image size
                                                        must be 1920 x 1133 px )</span>
                                                    <input type="file" name="banner_bg_image"
                                                        class="form-control image-check" id="banner_bg_image" required
                                                        data-width="1920" data-height="1133">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="banner_image_alt_tag" class="form-control"
                                                        id="banner_image_alt_tag" placeholder="Banner Image Alt Tag">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" name="image1" class="form-control image-check" id="image1" required="" data-width="112" data-height="112">
                                                    <div class="img-alert"></div>
                                                    <div class="invalid-feedback">
                                                            ...
                                                            <div class="mb-3">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="step_title">Step
                                                                        Title</label>
                                                                    <input type="text" name="step_title" class="form-control" id="step_title" placeholder="Step Title" required="">
                                                                    <div class="invalid-feedback">
                                                            ...
                                                            <div class="mb-3">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="step_sub_title">Step
                                                                        Subtitle</label>
                                                                    <input type="text" name="step_sub_title" class="form-control" id="step_sub_title" placeholder="Step Title" required="">
                                                                    <div class="invalid-feedback">
