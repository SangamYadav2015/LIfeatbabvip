                                        ...
                                        <div class="card-body">
                                            <div id="review-sections">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="tab_image_alt_tag[]"
                                                                class="form-control image-check" id="tab_image_alt_tag" placeholder="Image Alt Tag!">
                                                            <div class="invalid-feedback">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="button_text">Button
                                                                Text</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="button_url">Button
                                                                Url</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="step3_text">Step 3
                                                                Text</label>
                                                            <input type="text" name="step3_text[]" class="form-control"
                                                                id="step3_text" placeholder="Step 3 Text" required>
                                                            <div class="invalid-feedback">
                                                                Please provide a Step 3 Text!
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                 ...
                 <div class="review-section" style="border-top: 7px solid #fff;">
                       <div class="row">
                                  ...
                                  <div class="col-md-6">
                                     <div class="mb-3">
                                         <label class="form-label" for="tab_image_${reviewIndex}">Image 
                                            </label><span class="text-small text-danger">( Image size must be 494 x 570 px )</span>
                                             <input type="file" name="tab_image[]" class="form-control image-check" id="tab_image_${reviewIndex}" required  data-width="494" data-height="570">
                                         <div class="img-alert"></div>
                                         <div class="invalid-feedback">
                                             Please Choose  Image!
                                         </div>
                         ...
                         <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label class="form-label" for="step3_text">Step 3 Text</label>
                                                    <input type="text" name="step3_text[]" class="form-control" id="step3_text" placeholder="Step 3 Text"  required>
                                                    <div class="invalid-feedback">
                                                        Please provide a Step 3 Text!
                                                    </div> 
                                                </div>
