<div class="row">
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label" for="title">Title 1</label>
                  <input type="text" class="form-control" id="title" name="title" placeholder="Title 1" required>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="title2" name="title2" placeholder="Title 2" required>
                  <div class="invalid-feedback">
                    Please Enter Title 2! 
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  <label class="form-label" for="highlighted_title">Highlighted Title 2</label>
                  <input type="text" class="form-control" id="highlighted_title" name="highlighted_title" placeholder="Highlighted Title 2" required>
                  <div class="invalid-feedback">
                    Please Enter Highlighted Title 2!
                  </div>
                </div>
              </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        </label><span class="text-small text-danger">( Image size must be 536 x 300 px )</span>
                        <input type="file" name="step_image_icon[]" class="form-control image-check"
                          id="step_image_icon" required data-width="536" data-height="300">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input type="file" name="step_image_icon[]" class="form-control image-check" id="step_image_icon" required
                            data-width="536" data-height="300">
                          <div class="img-alert"></div>
                          <div class="invalid-feedback">
                            Please Choose  Image Thumbnail!
                          </div>
