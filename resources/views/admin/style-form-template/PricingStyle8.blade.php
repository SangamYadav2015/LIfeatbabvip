                                         ...
                                         <div class="row">
                                          ...
                                          <div class="row">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" name="step_image_icon[]" class="form-control image-check" id="step_image_icon" required="" data-width="45" data-height="74">
                                                    <div class="img-alert"></div>
                                                    <div class="invalid-feedback">
                                                        Please Choose Plan Offer Icon!
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
