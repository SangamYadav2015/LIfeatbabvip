                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="main_description" name="main_description" placeholder="Description" required>
                      <div class="invalid-feedback">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input type="file" name="step_image_icon[]" class="form-control image-check"
                            id="step_image_icon" required data-width="363" data-height="350">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input type="file" name="step_image[]" class="form-control image-check" id="step_image"
                            required data-width="1200" data-height="210">
                          <div class="img-alert"></div>
                          <div class="invalid-feedback">
                            Please Choose Image Thumbnail!
                          </div>
                      ...
                      <div class="col-md-12">
                        <div class="mb-3">
                          ...
                          <input type="text" name="detail_title[]" class="form-control" id="detail_title"
                            placeholder="Detailed Title" required>
                          <div class="invalid-feedback">
                ...
                <div class="review-section" style="border-top: 7px solid #fff;">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="mb-3">
                          <label class="form-label" for="step_image_icon">Image Thumbnail
                          </label><span class="text-small text-danger">( Image size must be 363 x 350 px )</span>
                          <input type="file" name="step_image_icon[]" class="form-control image-check" id="step_image_icon" required
                            data-width="363" data-height="350">
                          <div class="img-alert"></div>
                          <div class="invalid-feedback">
                            Please Choose  Image Thumbnail!
                          </div>
