                                         ...
                                         <div class="col-md-6">
                                           <div class="mb-3">
                                               <label class="form-label" for="client_image_${reviewIndex}">Client Image 
                                                   </label><span class="text-small text-danger">( Image size must be 50 x 50 px )</span>
                                               <input type="file" name="client_image[]" class="form-control image-check" id="client_image_${reviewIndex}" required  data-width="50" data-height="50">
                                               <div class="img-alert"></div>
                                               <div class="invalid-feedback">
                                                   Please Choose Client Image!
                                               </div>
