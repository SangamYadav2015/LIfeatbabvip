                                   ...
                                   <div class="card-body">
                                        <div id="review-sections">
                                          ...
                                          <div class="row">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="step_subtitle">Step Title</label>
                                                        <input type="text" class="form-control" name="step_title[]" id="step_subtitle" placeholder="Step Title"  required>
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label" for="step_image_icon">Step Image Icon 
                                                        </label><span class="text-small text-danger">( Image size must be 36 x 65 px )</span>
                                                    <input type="file" name="step_image_icon[]" class="form-control image-check" id="step_image_icon" required  data-width="36" data-height="65">
             ...
             var newReviewSection = `
                 <div class="review-section" style="border-top: 7px solid #fff;">
                     ...
                     <div class="row">
                         <div class="col-md-4">
                             <div class="mb-3">
                                 <label class="form-label" for="step_title${reviewIndex}">Step Title</label>
                                 <input type="text" class="form-control" name="step_title[]" id="step_title${reviewIndex}" placeholder="Step Title"  required>
                                 <div class="invalid-feedback">
                                     Please Enter Step Title!
                                 </div>
                             </div>
                           ...
                           <div class="col-md-4">
                                 <div class="mb-3">
                                     ...
                                     <input type="file" name="step_image_icon[]" class="form-control image-check" id="step_image_icon_${reviewIndex}" required  data-width="36" data-height="65">
                                     <div class="img-alert"></div>
                                     <div class="invalid-feedback">
                                         Please Choose Step Image Icon!
                                     </div>
