                                        ...
                                        <div id="review-sections">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" name="service_image_icon[]" class="form-control image-check" id="service_image_icon" required  data-width="36" data-height="65">
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-4">
                             <div class="mb-3">
                                 ...
                                 <input type="file" name="service_image_icon[]" class="form-control image-check" id="service_image_icon_${reviewIndex}" required  data-width="36" data-height="65">
                                 <div class="img-alert"></div>
                                 <div class="invalid-feedback">
                                     Please Choose Service Image Icon!
                                 </div>
