            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Edit Privacy Policy Category</a></li>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit Privacy Policy Category</h4>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Fill Privacy Policy Category Data</h4>
                                    <!-- <p class="card-title-desc">Provide valuable, actionable feedback to your users with HTML5 form validation–available in all our supported browsers.</p> -->
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" action="{{ route('admin.updatePrivacyPolicyCategory',[ 'num'=>$categoryData->id ] )}}" method="post" novalidate autocomplete="off">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <small id="nameExistsMessage" class="invalid-feedback" style="display: none;">Privacy Policy Category already exists.</small>
...
<script>
    $(document).ready(function() {
        $('#category_name').on('change', function() {
            ...
            $.ajax({
                url: '{{ route("admin.checkPrivacyPolicyCategory") }}',
                method: 'POST',
                data: {
