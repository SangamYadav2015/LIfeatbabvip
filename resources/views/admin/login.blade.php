...
@php
$decodeData =decodeData($thirdPartySetting->setting_data);
@endphp
@endif
<!doctype html>
<html lang="en">
...
<head>
    <meta charset="utf-8" />
    <title>Login | BABVIP - Admin LOGIN</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="BABVIP - Admin LOGIN" name="description" />
    ...
    @if(!empty($thirdPartySetting) && $decodeData['captcha_key'] !== null)
    <script src="https://www.google.com/recaptcha/enterprise.js?render={{ $decodeData['captcha_key'] }}"></script>
    @endif
</head>
...
<body data-topbar="dark">
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index.html" class="d-block auth-logo">
                                        <img src="{{ asset('admin/images/BABVIPLOGO.png') }}" alt="" height="28"> <span class="logo-txt">CMS Login</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        <h5 class="mb-0">Welcome Back !</h5>
                                        <p class="text-muted mt-2">Sign in to continue to BABVIP CMS.</p>
                                    </div>
                                    @if (session('success'))
                                    ...
                                    @endif
                                    <form method="post" action="{{ route('admin.checkLogin') }}" id="loginFormAdmin">
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                            <!--<div class="g-recaptcha" data-sitekey="6Lf28SQqAAAAAGu0gSAQpotVkDrGUzKjY5yEqjwJ"></div>-->
                                            @if(!empty($thirdPartySetting) && $decodeData['captcha_key'] != null)
                                            <button class="g-recaptcha  btn-primary w-100 waves-effect waves-light"
                                                data-sitekey="{{ $decodeData['captcha_key'] }}"
                                            ...
                                            @else
                                            <button type="submit" class="btn btn-primary w-100 waves-effect waves-light" id="loginBtn">
                                                Log In
                                            </button>
                                            @endif
    ...
    <script src="{{ asset('admin/js/pages/feather-icon.init.js') }}"></script>
    <script src="{{asset('admin/js/custom.js') }}"></script>
    @if(!empty($thirdPartySetting) && $decodeData['captcha_key'] !== null)
    <script>
        function onSubmit(token) {
            document.getElementById("loginFormAdmin").submit();
        }
    </script>
    @endif
</body>
