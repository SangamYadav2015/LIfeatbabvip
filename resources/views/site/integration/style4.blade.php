                        ...
                        <div class="feature-img-holder p-lg-5 pt-3">
                            <div class="bg-primary-soft p-lg-5 p-3 rounded-custom position-relative d-block feature-img-wrap">
                                <div class="position-relative">
                                    ...
                                    <img src="{{ asset("storage/uploads/".$decodeData['banner_image1']) }}" alt="{{ $decodeData['banner_image1_alt_tag'] }}"  class="img-fluid rounded-custom shadow position-absolute top--100 left--100 hide-medium aos-init aos-animate"  data-aos="fade-up" data-aos-delay="100">
                                </div>
