                        ...
                        <div class="feature-img-holder p-lg-5 pt-3">
                            <div class="p-lg-5 p-3 bg-danger-soft position-relative rounded-custom d-block feature-img-wrap">
                                ...
                                <img src="{{ asset("storage/uploads/".$decodeData['banner_image']) }}" alt="{{ $decodeData['banner_image1_alt_tag'] }}"  class="img-fluid rounded-custom position-relative aos-init aos-animate" data-aos="fade-up" data-aos-delay="50" >
                                    ...
                                    <img src="{{ asset("storage/uploads/".$decodeData['banner_image1']) }}" alt="{{ $decodeData['banner_image1_alt_tag'] }}" class="img-fluid rounded-custom shadow position-absolute bottom--100 right--100 hide-medium aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                                </div>
