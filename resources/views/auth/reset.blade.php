...
<head>
    <meta charset="utf-8" />
    <title>Login | BABVIP - Reset Your Password</title>
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index.html" class="d-block auth-logo">
                                        <img src="{{ asset('admin/images/BABVIPLOGO.png') }}" alt="" height="28"> <span class="logo-txt">CMS Reset Password</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        <h5 class="mb-0">Reset Your Password!</h5>
                                        <p class="text-muted mt-2">Fill Your Detail for reset password</p>
                                    </div>
                                    @if ($errors->any())
                                   ...
                                   <input  type="hidden" name="email" class="form-control" placeholder="Enter Email" required id="email" readonly value="{{ $_GET['email']}}">
                                        ...
                                        <div class="form-floating form-floating-custom mb-4">
                                        <input type="password"  class="form-control" name="password_confirmation" placeholder="Confirm Password" required id="confirm_password">
