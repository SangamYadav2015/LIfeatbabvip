...
<head>
    <meta charset="utf-8" />
    <title>BABVIP - Forgot Your Password</title>
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index.html" class="d-block auth-logo">
                                        <img src="{{ asset('admin/images/BABVIPLOGO.png') }}" alt="" height="28"> <span class="logo-txt">Applicant Forgot Password</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        <h5 class="mb-0">Forgot password !</h5>
                                        <p class="text-muted mt-2">Send reset password link.</p>
                                    </div>
                                    @if (session('success'))
