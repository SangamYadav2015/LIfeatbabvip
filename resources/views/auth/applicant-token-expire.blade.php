...
<head>
    <meta charset="utf-8" />
    <title> BABVIP Career Link Expired invalid </title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta content="BABVIP GROUP Link Expired invalid" name="description" />
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mb-5 pt-5">
                        <h1 class="error-title mt-5"><span>Link Expired or Invalid!</span></h1>
                        <h4 class="text-uppercase mt-5">Your password link has expired or Invalid. Please request a new password reset link.</h4>
                        <p class="font-size-15 mx-auto text-muted w-50 mt-4"></p>
                        <div class="mt-5 text-center">
                            <a href="{{ route('applicant.password.request') }}">Request a new password reset link</a>
                        </div>
                    </div>
                </div>
            </div>
