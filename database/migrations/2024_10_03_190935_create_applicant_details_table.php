...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('applicant_details', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('job_id')->unsigned(); // Adjust type as needed

            $table->bigInteger('applicant_id')->unsigned(); // Changed to bigInteger
            ...
            $table->string('most_recent_employment_dates')->nullable();
            ...
            $table->string('previous_employment_dates')->nullable();
